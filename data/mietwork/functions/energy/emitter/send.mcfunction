...
# 遍历所有类型需求，查找接收端
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_white=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_white_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_white_temp
tag @e[tag=mie_block_receive_white_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_orange=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_orange_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_orange_temp
tag @e[tag=mie_block_receive_orange_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_magenta=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_magenta_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_magenta_temp
tag @e[tag=mie_block_receive_magenta_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_l_blue=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_l_blue_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_light_blue_temp
tag @e[tag=mie_block_receive_light_blue_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_yellow=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_yellow_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_yellow_temp
tag @e[tag=mie_block_receive_yellow_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_lime=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_lime_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_lime_temp
tag @e[tag=mie_block_receive_lime_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_pink=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_pink_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_pink_temp
tag @e[tag=mie_block_receive_pink_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_gray=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_gray_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_gray_temp
tag @e[tag=mie_block_receive_gray_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_l_gray=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_l_gray_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_light_gray_temp
tag @e[tag=mie_block_receive_light_gray_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_cyan=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_cyan_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_cyan_temp
tag @e[tag=mie_block_receive_cyan_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_purple=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_purple_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_purple_temp
tag @e[tag=mie_block_receive_purple_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_blue=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_blue_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_blue_temp
tag @e[tag=mie_block_receive_blue_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_brown=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_brown_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_brown_temp
tag @e[tag=mie_block_receive_brown_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_green=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_green_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_green_temp
tag @e[tag=mie_block_receive_green_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_red=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_red_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_red_temp
tag @e[tag=mie_block_receive_red_temp] add mie_block_receive_temp
execute unless entity @e[tag=mie_block_receive_temp] at @s[scores={mie_eg_black=1..}] run tag @e[tag=mie_block_energy_receiver,tag=!mie_block_working,scores={mie_eg_black_t=1..},distance=..10,limit=1,sort=random] add mie_block_receive_black_temp
