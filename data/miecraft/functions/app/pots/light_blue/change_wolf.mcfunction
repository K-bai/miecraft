...
# 修改颜色
execute if score @s mie_eg_l_blue matches 1.. run data modify entity @e[tag=mie_ray_target,limit=1] CollarColor set from entity @s SelectedItem.tag.mie_data3
