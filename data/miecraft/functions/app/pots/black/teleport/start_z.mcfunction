# 计算z轴距离
execute store result score @s mie_temp1 run scoreboard players get @s mie_black_z
execute store result score @s mie_temp2 run data get entity @s Pos[2] 1
...
# 开始递归x轴 temp3保存剩余次数 temp4保存数字2 初始化temp5temp6
...
function miecraft:app/pots/black/teleport/recurse_z
