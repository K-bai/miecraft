# 计算x轴距离
execute store result score @s mie_temp1 run scoreboard players get @s mie_black_y
execute store result score @s mie_temp2 run data get entity @s Pos[1] 1
...
function miecraft:app/pots/black/teleport/recurse_y
