# create marker
execute at @s positioned ^ ^ ^4 run summon area_effect_cloud ~ ~ ~ {Tags:["wrnmd_mark","mie_ray_mark"],Duration:100}
...
kill @e[tag=wrnmd_mark,tag=!wrnmd_touch_edge]
execute as @e[tag=wrnmd_mark,tag=wrnmd_touch_edge,tag=wrnmd_touch_x_plus] at @s run tp @s ~1 ~ ~
execute as @e[tag=wrnmd_mark,tag=wrnmd_touch_edge,tag=wrnmd_touch_x_minus] at @s run tp @s ~-1 ~ ~
execute as @e[tag=wrnmd_mark,tag=wrnmd_touch_edge,tag=wrnmd_touch_y_plus] at @s run tp @s ~ ~1 ~
execute as @e[tag=wrnmd_mark,tag=wrnmd_touch_edge,tag=wrnmd_touch_y_minus] at @s run tp @s ~ ~-1 ~
execute as @e[tag=wrnmd_mark,tag=wrnmd_touch_edge,tag=wrnmd_touch_z_plus] at @s run tp @s ~ ~ ~1
execute as @e[tag=wrnmd_mark,tag=wrnmd_touch_edge,tag=wrnmd_touch_z_minus] at @s run tp @s ~ ~ ~-1
# clear tag
