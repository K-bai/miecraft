...
# 递归
execute if score @s mie_ray_dis matches ..16 anchored feet positioned ^ ^ ^0.25 if block ^ ^ ^ #uin:tech/solid_not unless entity @e[tag=mie_ray_target] run function miecraft:ray_cast/entity/recurse
