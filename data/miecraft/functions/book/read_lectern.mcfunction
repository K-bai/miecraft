...
# 检测书本版本 版本太老则删除
execute at @e[tag=mie_ray_mark] if block ~ ~ ~ minecraft:lectern[has_book=true]{Book:{tag:{mie_id:"magic_book"}}} unless block ~ ~ ~ minecraft:lectern[has_book=true]{Book:{tag:{mie_data1:"0.2.0"}}} run function miecraft:book/update
