...
recipes.append(infusion('circuit', inf_item('comparator', 'V'), 'ADVANCED'))
recipes[-1].add_energy('white', 20)
recipes[-1].add_item(inf_item('redstone', 'V'), 10)
recipes[-1].add_item(inf_item('redstone_torch', 'V'), 10)

recipes.append(infusion('small_display_panel', inf_item('glass_pane', 'V'), 'ADVANCED'))
recipes[-1].add_energy('white', 20)
recipes[-1].add_item(inf_item('glowstone_dust', 'V'), 5)

recipes.append(infusion('portable_machine_frame', inf_item('iron_bars', 'V'), 'ADVANCED'))
recipes[-1].add_energy('white', 10)
recipes[-1].add_item(inf_item('light_shell', 'MIE'), 2)
recipes[-1].add_item(inf_item('glue', 'MIE'), 1)
...
path_n_lock_core_items = 'infusion/recipes/main/lock_core_items.mcfunction'
path_a_lock_core_items = 'advanced_infusion/recipes/main/lock_core_items.mcfunction'
path_a_lock_other_items = 'advanced_infusion/recipes/main/lock_other_items.mcfunction'
# 能量需求模板和路径
file_n_core_items_add_energy = 'execute if entity @s[nbt={{Item:{{{0}}}}}] run function miecraft:crafting/infusion/recipes/{1}/energy'
file_a_core_items_add_energy = 'execute if entity @s[scores={{mie_item_inf_id={0}}}] run function miecraft:crafting/advanced_infusion/recipes/{1}/energy'
path_n_core_items_add_energy = 'infusion/recipes/main/energy_demand.mcfunction'
path_a_core_items_add_energy = 'advanced_infusion/recipes/main/energy_demand.mcfunction'
# 生成物品模板和路径
file_n_loot_items = 'execute if entity @s[nbt={{Item:{{{0}}}}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/{1}'
file_a_loot_items = 'execute if entity @s[scores={{mie_item_inf_id={0}}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/{1}'
path_n_loot_items = 'infusion/recipes/main/loot_items.mcfunction'
path_a_loot_items = 'advanced_infusion/recipes/main/loot_items.mcfunction'
...
path_n_all_items = 'infusion/recipes/main/advanced_infusion_interface.mcfunction'
path_a_all_items = 'advanced_infusion/recipes/main/other_items_detect.mcfunction'
