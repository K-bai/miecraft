...
execute if score @s mie_temp2 matches 5 run scoreboard players add @s mie_temp3 1
...
scoreboard players set @s mie_temp2 0
scoreboard players operation @s mie_temp2 += @e[type=item,tag=mie_item_temp,nbt={Item:{id:"minecraft:hopper"}}] mie_temp1
...
execute if score @s mie_temp3 matches 5 run scoreboard players set @s mie_item_inf_id 13950027
