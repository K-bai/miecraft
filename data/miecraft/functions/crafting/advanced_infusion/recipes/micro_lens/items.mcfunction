...
scoreboard players operation @s mie_temp2 += @e[type=item,tag=mie_item_temp,nbt={Item:{tag:{mie_id:"clear_ender_glass"}}}] mie_temp1
...
execute if score @s mie_temp3 matches 1 run scoreboard players set @s mie_item_inf_id 13950021
