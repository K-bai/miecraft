...
execute if entity @s[nbt={Item:{id:"minecraft:glass"}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/micro_lens
execute if entity @s[nbt={Item:{id:"minecraft:dispenser"}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/micro_field_generator
...
execute if entity @s[nbt={Item:{id:"minecraft:diamond_helmet"}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/sheep_helmet
execute if entity @s[nbt={Item:{id:"minecraft:diamond_chestplate"}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/sheep_chestplate
execute if entity @s[nbt={Item:{id:"minecraft:diamond_leggings"}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/sheep_leggings
execute if entity @s[nbt={Item:{id:"minecraft:diamond_boots"}}] at @s run loot spawn ~ ~ ~ loot miecraft:items/sheep_boots
