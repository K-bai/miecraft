...
execute if entity @s[tag=!mie_item_inf_locked] if score @s mie_temp6 matches 1 if entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}] unless data entity @s Item.tag.mie_id run function miecraft:crafting/infusion/recipes/diamond_sword/energy
# 增加tag
