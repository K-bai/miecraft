execute if score @s mie_eg_white matches 100.. run summon minecraft:area_effect_cloud ~ ~-1 ~ {Tags:["mie_pot_craft_effect_magenta","mie_pot_craft_effect"],Duration:999}
